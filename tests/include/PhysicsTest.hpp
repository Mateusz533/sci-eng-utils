...
namespace PhysicsTest
{
	...
	TEST(PhysicsTestSuite, NStdUnitRelationsTest) {
		...
		static_assert(NStd::Percents<>{100} == SI::Scale<>{1});
		static_assert(NStd::Permille<>{1000} == SI::Scale<>{1});
		static_assert(NStd::Degrees<>{180} == SI::Radians<>{std::numbers::pi});
		static_assert(NStd::Arcminutes<>{60} == NStd::Degrees<>{1});
		static_assert(NStd::Arcseconds<>{60} == NStd::Arcminutes<>{1});
		...
		static_assert(NStd::Roods<>{4} == NStd::Acres<>{1});
		static_assert(NStd::Acres<>{1} == NStd::SquareYards<>{4'840});

		static_assert(NStd::Ares<>{1} == SI::SquareMeters<>{100});
		static_assert(NStd::Hectares<>{1} == NStd::Ares<>{100});
		...
		static_assert(NStd::Cords<>{1} == NStd::CubicFeet<>{128});

		static_assert(NStd::UsMinims<>{60} == NStd::UsFluidDrams<>{1});
		static_assert(NStd::UsFluidDrams<>{8} == NStd::UsFluidOunces<>{1});
		static_assert(NStd::UsFluidOunces<>{4} == NStd::UsGills<>{1});
		static_assert(NStd::UsGills<>{2} == NStd::UsMeasures<>{1});
		static_assert(NStd::UsCups<>{1} == NStd::UsMeasures<>{1});
		static_assert(NStd::UsMeasures<>{2} == NStd::UsLiquidPints<>{1});
		static_assert(NStd::UsLiquidPints<>{2} == NStd::UsLiquidQuarts<>{1});
		static_assert(NStd::UsLiquidQuarts<>{4} == NStd::UsGallons<>{1});
		static_assert(NStd::UsGallons<>{1} == NStd::Liters<>{3.785'411'784}.ToStandardUnit());
		static_assert(NStd::PetroleumBarrels<>{1} == NStd::UsGallons<>{42});

		static_assert(NStd::UsDryPints<>{2} == NStd::UsDryQuarts<>{1});
		static_assert(NStd::UsDryQuarts<>{8} == NStd::UsPecks<>{1});
		static_assert(NStd::UsPecks<>{4} == NStd::UsBushels<>{1});
		static_assert(NStd::UsBushels<>{1} == NStd::CubicInches<>{2'150.42});

		static_assert(NStd::ImperialFluidMinims<>{60} == NStd::ImperialFluidDrachms<>{1});
		static_assert(NStd::ImperialFluidDrachms<>{8} == NStd::ImperialFluidOunces<>{1});
		static_assert(NStd::ImperialFluidOunces<>{5} == NStd::ImperialGills<>{1});
		static_assert(NStd::ImperialGills<>{4} == NStd::ImperialPints<>{1});
		static_assert(NStd::ImperialPints<>{2} == NStd::ImperialQuarts<>{1});
		static_assert(NStd::ImperialQuarts<>{4} == NStd::ImperialGallons<>{1});
		static_assert(NStd::ImperialGallons<>{1} == NStd::Liters<>{4.546'090});
		...
		static_assert(NStd::Minutes<>{1} == SI::Seconds<>{60});
		static_assert(NStd::Hours<>{1} == NStd::Minutes<>{60});
		static_assert(NStd::Days<>{1} == NStd::Hours<>{24});
		static_assert(NStd::Weeks<>{1} == NStd::Days<>{7});
		...
		static_assert(NStd::Grains<>{7'000} == NStd::Drams<>{1});
		static_assert(NStd::Pennyweights<>{1} == NStd::Grains<>{24});
		static_assert(NStd::TroyOunces<>{1} == NStd::Pennyweights<>{20});
		static_assert(NStd::TroyPounds<>{1} == NStd::TroyOunces<>{12});
		static_assert(NStd::Drams<>{16} == NStd::Ounces<>{1});
		static_assert(NStd::Ounces<>{16} == NStd::PoundsMass<>{1});
		static_assert(NStd::PoundsMass<>{1} == SI::KiloGrams<>{0.453'592'370});
		static_assert(NStd::Stones<>{1} == NStd::PoundsMass<>{14});
		static_assert(NStd::Quarters<>{1} == NStd::Stones<>{2});
		static_assert(NStd::Centals<>{1} == NStd::PoundsMass<>{100});
		static_assert(NStd::ShortHundredweights<>{1} == NStd::Centals<>{1});
		static_assert(NStd::LongHundredweights<>{1} == NStd::Quarters<>{4});
		static_assert(NStd::ShortTons<>{1} == NStd::ShortHundredweights<>{20});
		static_assert(NStd::LongTons<>{1} == NStd::LongHundredweights<>{20});
		static_assert(NStd::Slug<>{1} == NStd::PoundsForce<>{1} / (NStd::FeetPerSecond<>{1} / SI::Seconds<>{1}));

		static_assert(NStd::Tons<>{1} == SI::KiloGrams<>{1'000});

		static_assert(NStd::StandardGravity<>{1} == SI::MetersPerSecondSquared<>{9.806'650});
		...
		static_assert(NStd::Kips<>{1} == NStd::PoundsForce<>{1'000});
		...
		static_assert(NStd::DegreesRankin<>{9} == SI::Kelvins<>{5});
	}
}